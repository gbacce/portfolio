    ...
    return (
      <Grid fluid>
        <Row>
          ...
          <Col xs={12} className='connect-heading text-center'>
            <h1 className='type-it'>Connect</h1>
          </Col>
          <Col xs={10} xsOffset={1} md={8} mdOffset={2} lg={6} lgOffset={3} className='connect-content'>
            <Col xs={12} className='connect-subheading text-center'>
              <h3>Let's get in touch!</h3>
            </Col>
            <Col xs={4} className='contact-div text-center'>
              <h4></h4>
              <a href='http://github.com/gbacce'><Image className='connect-icon' src={GitHub} responsive /></a>
            </Col>
            <Col xs={4} className='contact-div text-center'>
              <h4></h4>
              <a href='http://linkedin.com/in/gbacce'><Image className='connect-icon' src={LinkedIn} responsive /></a>
            </Col>
            <Col xs={4} className='contact-div text-center'>
              <h4></h4>
              <a href='/Resume_GuidoBacce.pdf'><Image className='connect-icon' src={Resume} responsive /></a>
            </Col>
            <Col xs={10} xsOffset={1} className='contact-div text-center'>
              <h4></h4>
              <a href='mailto:gbacce@gmail.com'><Image className='email-icon' src={Email} responsive /></a>
            </Col>
          </Col>
          <Col xs={3}></Col>
        </Row>
