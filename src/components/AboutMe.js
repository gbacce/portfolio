...
import AboutMeBackgroundImage from '../images/background-images/about-me-static-image.png'
    ...
    return (
      <Grid fluid>
        <div className="fullscreen-bg">
            <video loop muted autoPlay poster={AboutMeBackgroundImage} className="fullscreen-bg__video">
        ...
        <Row>
          ...
          <Col sm={12} className='about-section'>
            ...
            <Col className='about-content' xsOffset={1} xs={10} smOffset={2} sm={8} mdOffset={1} md={4}>
              ...
              <p>{/*Sentence about code*/}</p>

              <p>Outside of programming, I have a passion for music. When I'm not writing code, you can find me producing music or playing the guitar.</p>
